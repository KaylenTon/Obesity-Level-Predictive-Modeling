...
# 1 roc_auc	    0.9629274	    0.9750240	    0.9852812	
# 2 sens	      0.8455354	    0.8670822	    0.8976190	
# 3 spec	      0.9748247	    0.9786377	    0.9840322	
...
# Tuned Decision Tree Model Results
  # accuracy	    multiclass	  0.89622642	
  # roc_auc	      hand_till	    0.98111992	
  # brier_class	  multiclass	  0.08672105	

```

# Model 3 - Gradient Boosted Tree Model
...
# Test + Predict
class_preds <- predict(boosted_fit, new_data = obesity_test, type = "class")
prob_preds <- predict(boosted_fit, new_data = obesity_test, type = "prob")

prediction_results <- obesity_test %>%
  select(NObeyesdad) %>%
  bind_cols(class_preds, prob_preds)

# Calculate AUC
roc_auc(prediction_results,
        truth = NObeyesdad,
        starts_with(".pred_"),
        - .pred_class,
        estimator = "macro")
...
# roc_auc	    macro	        0.998096	

# Visualizing roc curve
roc_curve_3 <- roc_curve(prediction_results,
        truth = NObeyesdad,
...
# Model 4 - Gradient Boosted Tree Model w/ Tuned Hyper-Parameters
...
# Tuned Gradient Boost Model Results
  # accuracy	    multiclass	  0.96981132
  # roc_auc	      hand_till	    0.99883843
  # brier_class	  multiclass	  0.02134977
